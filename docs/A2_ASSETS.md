...
| 3 | Helicóptero medicalizado | GENÉRICO_JUEGO | **Poly Pizza — kazuma** | **CC0** | **INTEGRADO** | `assets/models/polypizza/helicopter-kazuma.glb` (44 KB, 1.094 tris, escala 1.4, `center` + `rotateY: π`). Todo amarillo SEM salvo rotor y cristal. Elegido por el usuario sobre el de Poly by Google (CC-BY). https://poly.pizza/m/EQJ2MECUbx |
