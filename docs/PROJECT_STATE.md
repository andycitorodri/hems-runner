...
- **Caso abierto (beta del 24 sep)**: 20 de 162 partidas superan los 400 p/m (hasta 2.166), repartidas en **7 dispositivos distintos**, y el mismo jugador alterna partidas normales (10-20 p/m) con imposibles minutos después. Con el código actual no se reproduce: un bot invencible recogiéndolo todo durante 11 km no pasa de 9 p/m. Queda pendiente ver el desglose de las próximas partidas marcadas para decidir si es un fallo en dispositivos reales o envíos manipulados.
