...
**Versión actual**: Fase 2 · A1 y A2 cerrados (A2 en rama `phase-2-a2`, sin mergear a `main` aún); A3 en curso (escenario instanciado, edificios Kenney, cielo/Ambience, carrusel de landmarks: Sagrada → Torre Glòries → Camp Nou). Idiomas CA/ES, dominio hems.jornadaimpacte.com, rendimiento móvil (LightPool, warm-up, DynamicRes)
...
- Pendientes de este carrusel: Arc de Triomf (modelo Sketchfab por elegir/descargar el usuario), Hotel W (procedural, vela) con bioma Costa Barceloneta (palmeras, mar).
